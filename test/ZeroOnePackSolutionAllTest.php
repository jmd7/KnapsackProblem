...
class ZeroOnePackSolutionAllTest extends TestCase {
    private $solutions = [
        "rg4\\knapsack\\ZeroOnePack_SolutionAll_00",
        "rg4\\knapsack\\ZeroOnePack_SolutionAll_01",
        "rg4\\knapsack\\ZeroOnePack_SolutionAll_02",
        "rg4\\knapsack\\ZeroOnePack_SolutionAll_final",
    ];
    ...
    public function test01() {
        ...
        Helper::getInstance()->performCheckingAllSolutions(__METHOD__, $this->solutions, $items, $pack, 14650);
    }
