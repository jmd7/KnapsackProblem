...
class CompletePackSolutionAllTest extends TestCase {
    private $solutions = [
        "rg4\\knapsack\\CompletePack_SolutionAll_00",
        "rg4\\knapsack\\CompletePack_SolutionAll_01",
        "rg4\\knapsack\\CompletePack_SolutionAll_02",
        "rg4\\knapsack\\CompletePack_SolutionAll_03",
        "rg4\\knapsack\\CompletePack_SolutionAll_final",
    ];
    ...
    public function test01() {
        ...
        Helper::getInstance()->performCheckingAllSolutions(__METHOD__, $this->solutions, $items, $pack, 15940);
    }
